      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <p className="text-white">
            By disconnecting your wallet, you agree to our{" "}
            <a
          ...
          <div
            className={`flex items-center justify-between w-full p-3 rounded-lg cursor-pointer bg-[#010406] border border-lime text-base`}
            style={{
          ...
          />
          <div className="flex gap-x-2 text-red">
            <button
